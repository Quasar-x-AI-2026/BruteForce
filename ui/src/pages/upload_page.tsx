      ...
      <div className="card w-full max-w-sm min-h-[90vh] flex flex-col">
        ...
        <div className="brand mb-6">
          <span className="brand-icon">
            <img src="/images/letter-k.ico" className="brand-logo" alt="brand logo" />
          </span>
          <span>Krafti</span>
        </div>
        ...
        {!uploading && (
          <>
            <h1 className="heading">Upload Your Craft</h1>

            <p className="subtitle mt-3">
              Turn a simple photo into a professional product listing
            </p>

            <div onClick={handleUploadClick} className="upload-box mt-10">
              <input
                ref={fileInputRef}
                type="file"
                hidden
        ...
        {uploading && (
          <>
            <h1 className="heading">Creating Your Listing</h1>
